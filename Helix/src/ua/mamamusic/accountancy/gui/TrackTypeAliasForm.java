...
public class TrackTypeAliasForm extends JDialog {
	...
	private TrackTypeAlias alias;
	private JLabel lblDistribobject;
	private TrackTypeAliasListListener listener;


	/**
	 * Create the dialog.
	 */
	public TrackTypeAliasForm() {
		
		init();
		
	}
	public TrackTypeAliasForm(Window owner, String title, TrackTypeAlias alias, TrackTypeAliasListListener listener) {
		super(owner, "TrackType Alias Form", Dialog.ModalityType.DOCUMENT_MODAL);
		this.title = title;
		this.alias = alias;
	...
	private void init(){
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				JLabel lblDistributor = new JLabel("Track type:");
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						if(listener != null && alias != null){
							...
							TrackTypeAliasForm.this.dispose();
						}
					}
				});
