...
public class TrackAliasForm extends JDialog {
	...
	private TracksAliasListListener listener;


	/**
	 * Create the dialog.
	 */
	public TrackAliasForm() {
		
		init();
		
	}
	public TrackAliasForm(Window owner, String title,
			TrackAlias alias, TracksAliasListListener listener) {
	...
	private void init(){
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				JLabel lblDistributor = new JLabel("Track:");
