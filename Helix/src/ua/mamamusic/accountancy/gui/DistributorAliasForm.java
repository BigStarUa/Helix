...
public class DistributorAliasForm extends JDialog {
	...
	private DistributorAlias alias;
	private JLabel lblDistribobject;
	private DistributerAliasListListener listener;


	/**
	 * Create the dialog.
	 */
	public DistributorAliasForm() {
		
		init();
		
	}
	public DistributorAliasForm(Window owner, String title,
			DistributorAlias alias, DistributerAliasListListener listener) {
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						if(listener != null && alias != null){
							...
							DistributorAliasForm.this.dispose();
						}
					}
				});
